      ...
      <section className="relative pt-40 pb-20 px-4 min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center z-10">
          ...
          <p className="text-xl md:text-2xl text-white/95 mb-12 text-balance drop-shadow-md">
            Get personalized university recommendations and guidance for
            Bangladesh admissions with our AI-powered advisor
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <AnimatedCard
              delay={0.1}
              borderBeam
              className="bg-white p-8 rounded-xl border-2 border-green-200 hover:border-green-500 hover:shadow-lg transition shadow-md"
            >
              ...
              <p className="text-muted-foreground">
                Ask any question about universities, programs, and the admission
                process. Our AI advisor provides instant, personalized
                responses.
              </p>
            </AnimatedCard>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Check if you meet the requirements for your desired programs.
                Get detailed information about cutoff marks and prerequisites.
              </p>
            </AnimatedCard>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Get personalized university and program recommendations based on
                your marks, interests, and preferences.
              </p>
            </AnimatedCard>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Side-by-side comparison of universities and programs. Make
                informed decisions with detailed program information.
              </p>
            </AnimatedCard>
          </div>
        </div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center z-10">
          ...
          <p className="text-lg text-white/90 mb-8 drop-shadow-md">
            Start your admission journey with EduGuide. Chat with our AI advisor
            today and get personalized guidance.
          </p>
          <Link href="/chat">
            <BorderBeamButton
              size="lg"
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                AI-powered university admission guidance for Bangladesh
                students.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <Link href="/universities/du" className="hover:text-primary">
                    University of Dhaka
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
            ...
            <Link
              href="/admin/upload"
              className="inline-block mt-2 text-xs text-muted-foreground/50 hover:text-primary"
            >
              Admin
            </Link>
          </div>
