  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8 space-y-8">
      ...
      <div className="bg-gradient-to-r from-amber-900/60 via-slate-900 to-slate-900 border border-amber-500/30 rounded-2xl p-6 shadow-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-amber-400 font-semibold text-xs uppercase tracking-widest">
            ...
            <span>Target Goal Selected</span>
          </div>
          ...
          <p className="text-sm text-slate-300">
            Personalized preparation roadmap actively tracking weak concepts and daily schedule.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 bg-slate-950/80 p-4 rounded-xl border border-slate-800 shrink-0">
          <div className="text-center px-3 border-r border-slate-800">
            ...
            <div className="text-[10px] text-slate-400 uppercase font-semibold">Days Remaining</div>
          </div>
          <div className="text-center px-3 border-r border-slate-800">
          ...
          <div className="text-center px-3">
            ...
            <div className="text-[10px] text-slate-400 uppercase font-semibold">Overall Prep</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Left 2 Columns: Today's Plan & Weak Topics */}
        <div className="lg:col-span-2 space-y-8">
          
          {/* PRIMARY ACTION CARD: "WHAT SHOULD I DO RIGHT NOW?" */}
          <div className="bg-slate-900 border border-amber-500/40 rounded-xl p-6 shadow-xl space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-amber-400 font-bold text-lg">
                <Sparkles className="w-5 h-5" />
                <h2>What Should You Study Right Now?</h2>
              </div>
              <span className="text-xs text-slate-400">Deterministic Recommendation</span>
            </div>
            ...
            <div className="p-4 bg-slate-950 rounded-lg border border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <div className="text-xs font-semibold text-amber-400 uppercase tracking-wider">High Priority Action</div>
          ...
          {/* Today's Personalized Plan Tasks */}
        ...
        {/* Right Column: Subject Breakdown & Preparation Tools */}
        <div className="space-y-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-3 shadow-xl">
            <h3 className="font-bold text-sm text-slate-400 uppercase tracking-wider mb-2">Preparation Navigation</h3>
