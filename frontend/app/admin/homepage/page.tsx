              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <span>Universities Directory ({admissionRows.length})</span>
                  </Link>
              ...
              <div className="space-y-3">
                <div className="p-3.5 rounded-2xl bg-orange-50/70 border border-orange-200/80 flex items-start gap-2.5 text-xs text-slate-700">
                  ...
                  <div className="leading-relaxed">
                    <strong className="text-slate-900 font-bold">Live Relational Data Feed:</strong> The rows below (Application Windows, Exam Dates, GPA Cutoffs, and Status) are automatically synchronized from your{' '}
                    <Link href="/admin/circulars" className="text-[#FF5500] font-bold underline hover:text-[#E04B00]">
                      Circulars & Deadlines
                    </Link>
                    . Updating a circular immediately updates the public homepage table!
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-slate-400">
                    Dates & requirements derived from active circulars
                  </span>
                </div>
                        ...
                        <tr key={row.id} className="hover:bg-slate-50/70 transition">
                          ...
                          <td className="py-3 px-3 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              <Link
                                href={`/admin/circulars?search=${encodeURIComponent(row.shortName || row.name)}`}
